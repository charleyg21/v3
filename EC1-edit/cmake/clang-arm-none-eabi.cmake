...
set(GCC_INCLUDES_COMMAND python ${CMAKE_CURRENT_LIST_DIR}/../scripts/includes.py)
execute_process(COMMAND ${GCC_INCLUDES_COMMAND} OUTPUT_VARIABLE GCC_INCLUDES)
include_directories(BEFORE ${GCC_INCLUDES})
